...
run_job "compute_spy_feature_snapshots" "Spy Feature Snapshots (Phase 2)"
run_job "compute_identity_resolution" "Identity Resolution (Phase 3)"
run_job "graph_spy_ring_projection" "Spy Ring Projection (Phase 4)"
run_job "compute_spy_network_cases" "Spy Network Cases (Phase 4)"
run_job "compute_spy_risk_profiles" "Spy Risk Profiles (Phase 5)"
run_job "train_spy_shadow_model" "Shadow ML Train (Phase 6)"
run_job "score_spy_shadow_ml" "Shadow ML Score (Phase 6)"
...
run_job "graph_query_plan_validation" "Graph Query Plan Validation"
