...
function db_pipeline_observatory_data(): array
{
    ...
    $stageJobKeys = [
        ...
        'intelligence' => ['compute_suspicion_scores_v2', 'compute_alliance_dossiers', 'compute_threat_corridors', 'compute_counterintel_pipeline', 'intelligence_pipeline', 'compute_battle_rollups', 'compute_behavioral_scoring', 'compute_sovereignty_alerts', 'compute_bloom_entry_points'],
