...
CREATE TABLE IF NOT EXISTS killmail_events (
    ...
    mail_type ENUM('kill', 'loss', 'opponent_loss', 'opponent_kill', 'third_party', 'untracked') NOT NULL DEFAULT 'loss',
...
CREATE TABLE IF NOT EXISTS ref_npc_stations (
    ...
    orbit_id INT UNSIGNED DEFAULT NULL,
    owner_id INT UNSIGNED DEFAULT NULL,
    operation_id SMALLINT UNSIGNED DEFAULT NULL,
    use_operation_name TINYINT UNSIGNED NOT NULL DEFAULT 0,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
INSERT INTO app_settings (setting_key, setting_value) VALUES
    ...
    ('esi_scopes', 'publicData esi-location.read_location.v1 esi-search.search_structures.v1 esi-universe.read_structures.v1 esi-characters.write_contacts.v1 esi-markets.structure_markets.v1 esi-characters.read_standings.v1'),
    ('ollama_enabled', '0'),
