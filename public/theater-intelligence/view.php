...
<section class="surface-primary mt-4">
    ...
    <p class="mt-1 text-sm text-slate-300 leading-relaxed"><?= htmlspecialchars((string) ($aiSummary['summary'] ?? ''), ENT_QUOTES) ?></p>
    <p class="mt-2 text-[10px] text-slate-500">Generated by <?= htmlspecialchars((string) ($aiSummary['model'] ?? ''), ENT_QUOTES) ?> at <?= htmlspecialchars((string) ($aiSummary['generated_at'] ?? ''), ENT_QUOTES) ?></p>
</section>
<?php endif; ?>
