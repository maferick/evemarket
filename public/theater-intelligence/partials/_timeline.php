        ...
        <div class="mt-2">
            ...
            <?php foreach ($turningPoints as $tp): ?>
                ...
                <p class="text-xs text-slate-300">
                    <span class="<?= $tpColor ?>"><?= htmlspecialchars((string) ($tp['turning_point_at'] ?? ''), ENT_QUOTES) ?></span>
            ...
            <table class="table-ui">
                <thead>
                    <tr class="border-b border-border/70 text-xs uppercase tracking-[0.15em] text-muted">
                        ...
                        <th class="px-3 py-2 text-right <?= $sideColorClass[$ourSide] ?? '' ?>"><?= htmlspecialchars($sideLabels[$ourSide] ?? 'Side A', ENT_QUOTES) ?></th>
                ...
                <tbody>
                    <?php foreach ($timeline as $t): ?>
                        ...
                        <tr class="border-b border-border/50">
                            ...
                            <td class="px-3 py-2 text-right <?= $sideColorClass[$ourSide] ?? 'text-blue-300' ?>"><?= (int) ($t['side_a_kills'] ?? 0) ?></td>
