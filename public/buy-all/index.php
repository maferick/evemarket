                            ...
                            <tr data-buyall-item data-buyall-name="<?= htmlspecialchars((string) ($item['item_name'] ?? ''), ENT_QUOTES) ?>" data-buyall-qty="<?= (int) ($item['final_planner_quantity'] ?? $item['quantity'] ?? 0) ?>" data-buyall-sell="<?= htmlspecialchars(isset($item['sell_price']) && $item['sell_price'] !== null ? number_format((float) $item['sell_price'], 2, '.', '') : '', ENT_QUOTES) ?>" data-buyall-hub="<?= (int) ($item['hub_available_quantity'] ?? 0) ?>">
                                ...
                                <td class="px-4 py-3 align-top">
                                    ...
                                    <?php
                                        ...
                                        $hasLossData = ($item['loss_daily_rate'] ?? null) !== null && (float) ($item['loss_daily_rate'] ?? 0) > 0.0;
                                    ...
                                    <?php elseif ($hasLossData): ?>
                                        <p class="mt-1 text-xs text-indigo-300">Loses <?= htmlspecialchars(number_format((float) ($item['loss_daily_rate'] ?? 0), 1), ENT_QUOTES) ?>/day (<?= htmlspecialchars((string) ($item['loss_rate_window'] ?? ''), ENT_QUOTES) ?> avg) · <?= htmlspecialchars((string) ($item['runway_days_target'] ?? 30), ENT_QUOTES) ?>d runway target</p>
                                        <p class="mt-1 text-xs text-slate-500">Losses: 1d <?= htmlspecialchars(number_format((int) ($item['loss_quantity_1d'] ?? 0)), ENT_QUOTES) ?> · 7d <?= htmlspecialchars(number_format((int) ($item['loss_quantity_7d'] ?? 0)), ENT_QUOTES) ?> · 14d <?= htmlspecialchars(number_format((int) ($item['loss_quantity_14d'] ?? 0)), ENT_QUOTES) ?> · 30d <?= htmlspecialchars(number_format((int) ($item['loss_quantity_30d'] ?? 0)), ENT_QUOTES) ?></p>
                                    <?php else: ?>
                                ...
                                <td class="px-4 py-3 align-top">
                                    ...
                                    <details class="mt-2 rounded-lg border border-white/8 bg-white/[0.03] px-3 py-2">
                                        ...
                                        <div class="mt-2 space-y-2">
                                            ...
                                            <?php endif; ?>
                                            <?php if (($item['loss_daily_rate'] ?? null) !== null && (float) ($item['loss_daily_rate'] ?? 0) > 0.0): ?>
                                                <p class="text-xs text-indigo-200/85">Loss history: 1d <?= htmlspecialchars(number_format((int) ($item['loss_quantity_1d'] ?? 0)), ENT_QUOTES) ?> · 7d <?= htmlspecialchars(number_format((int) ($item['loss_quantity_7d'] ?? 0)), ENT_QUOTES) ?> · 14d <?= htmlspecialchars(number_format((int) ($item['loss_quantity_14d'] ?? 0)), ENT_QUOTES) ?> · 30d <?= htmlspecialchars(number_format((int) ($item['loss_quantity_30d'] ?? 0)), ENT_QUOTES) ?> · <?= htmlspecialchars(number_format((float) ($item['loss_daily_rate'] ?? 0), 1), ENT_QUOTES) ?>/day (<?= htmlspecialchars((string) ($item['loss_rate_window'] ?? ''), ENT_QUOTES) ?>) · loss qty <?= htmlspecialchars((string) ($item['loss_recommended_quantity'] ?? 0), ENT_QUOTES) ?></p>
                                            <?php endif; ?>
