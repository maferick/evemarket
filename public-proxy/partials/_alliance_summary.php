                    ...
                    <tr class="border-b border-border/50">
                        ...
                        <td class="px-3 py-2 <?= $aSideColor ?>">
                            <span class="inline-block rounded-full px-2 py-0.5 text-[10px] uppercase tracking-wider <?= $aSideBg ?>">
                                <?= proxy_e($sideLabels[$aSide] ?? $aSide) ?>
                            </span>
                        </td>
                        ...
                        <td class="px-3 py-2 text-right"><?= proxy_format_isk((float) ($a['total_isk_killed'] ?? 0)) ?></td>
                        <td class="px-3 py-2 text-right"><?= proxy_format_isk((float) ($a['total_isk_lost'] ?? 0)) ?></td>
